...
CREATE TABLE `teams` (
  ...
  INDEX i1 (`withdrawn`, `created_at` DESC)
) ENGINE=InnoDB DEFAULT CHARACTER SET utf8mb4;
...
ALTER TABLE `benchmark_jobs` ADD INDEX idx4 (`team_id`, `created_at` DESC);
...
CREATE TABLE `clarifications` (
  ...
  `created_at` DATETIME(6) NOT NULL,
  `updated_at` DATETIME(6) NOT NULL,
  INDEX i1 (`answered_at`, `team_id`),
  INDEX i2 (`updated_at` DESC)
) ENGINE=InnoDB DEFAULT CHARACTER SET=utf8mb4;
